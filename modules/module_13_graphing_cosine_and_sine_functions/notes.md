...
<!-- TOC -->
* [Module 13 - Graphing Cosine and Sine Functions](&le;module-13---graphing-cosine-and-sine-functions)
* [General Notes](&le;general-notes)
* [Graphing **x(&theta;) = cos(&theta;)** and **y(&theta;) = sin(&theta;)**](&le;graphing-xtheta--costheta-and-ytheta--sintheta)
<!-- TOC -->
